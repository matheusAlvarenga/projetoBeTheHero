    ...
    return(
        ...
        <div className="profile-container">
            ...
            <header>
                ...
                <button onClick={handleLogout}><FiPower style={{ marginTop: -4 }} size={18} color="#E02041" /></button>
            </header>
            ...
            <ul>
                ...
                {incidents.map(incident => (
                    ...
                    <button onClick={() => handleDeleteIncident(incident.id)} className="trash" type="button"><FiTrash2 size={20} color="#A8A8B3" /></button>
                    </li>
