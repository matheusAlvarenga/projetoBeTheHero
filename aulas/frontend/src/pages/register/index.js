        ...
        <div className="register-container">
            ...
            <div className="content">
                ...
                <section>
                    ...
                    <Link className="link-entrada" to="../"><FiArrowLeft size={16} color="#E02041"/> Tenho cadastro</Link>
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className="input-group">
                        ...
                        <input value={city} onChange={e => setCidade(e.target.value)}  type="text" placeholder="cidade" />
